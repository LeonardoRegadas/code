...
# você deve fazer os funcionários registrarem a entrada e a saida com base no seu expediente
# você deve informar caso ele entre atrasado ou saia adiantado e mostrar quanto foi esse atraso ou adiantamento
